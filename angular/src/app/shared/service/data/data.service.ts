...
export class DataService {
  public getEnterpriseData(): Observable<any> {
    return this.http.get('assets/JSON/enterprises.json').pipe(
      map((res: any) => {
        return res.data; // Assuming "data" contains the array of enterprises
      })
    );
  }
  public servicesList(): Observable<any> {
    return this.http.get('assets/JSON/servicesList.json').pipe(
      map((res: any) => {
        return res;
      })
    );
