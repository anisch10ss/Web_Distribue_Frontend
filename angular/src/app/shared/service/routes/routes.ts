...
export class routes {
  ...
  /*public static get enterpriseCard(): string {
    return this.baseUrl + '/enterprisecard/';
  }*/

  /*public static get enterpriseMatching(): string {
    return this.baseUrl + '/enterprisematching/';
  }*/
  public static get matches(): string {
    return this.baseUrl + '/matches/';
  }
  public static get entrepriseaddmatching(): string {
    return this.baseUrl + '/matches/add/';
  }
